...
if(isset($_POST["captcha"])){
    ...
    if(!empty($captcha)){
        ...
        $error_message = "<p class='mesage_err'><strong>Ошибка!</strong> Поле для ввода капчи не должна быть пустой. </p>";
...
if(isset($_POST["email"])){
    ...
    if(!empty($email)){
        ...
        if( !preg_match($reg_email, $email)){
            // Сохраняем в сессию сообщение об ошибке. 
            $_SESSION["error_messages"] .= "<p class='mesage_err' >Вы ввели неправильный email</p>";
        ...
        // Сохраняем в сессию сообщение об ошибке. 
        $_SESSION["error_messages"] .= "<p class='mesage_err' >Поле для ввода почтового адреса(email) не должна быть пустой.</p>";
...
if(!$result_query_select){
    // Сохраняем в сессию сообщение об ошибке. 
    $_SESSION["error_messages"] .= "<p class='mesage_err' >Ошибка запроса на выборке пользователя из БД</p>";
    ...
    if($result_query_select->num_rows == 1){
        ...
        // Сохраняем в сессию сообщение об ошибке. 
        $_SESSION["error_messages"] .= "<p class='mesage_err' >Неправильный логин и/или пароль</p>";
